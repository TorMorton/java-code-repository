 ...
 * -- priority for code == inline code first, then promises, then regular fallbacks
 */
...
function Parrot(name, age, crackerPreferences) {
    this.name = name ?? this.name;
    this.age = age;
    this.crackerPreferences = crackerPreferences;
...
//    name: 'Name',
//    age: 45,
//    crackerPreferences: 'Wheat'
//}


// create one using the new keyword
const polly = new Parrot('Polly', 75, 'Saltine');
console.log(polly);
...
// Each instance has .__proto__ property, which points to the function's .prototype property (which is an object)

console.log(Parrot.prototype === polly.__proto__);

polly.speak();

polly.__proto__.eat = () => console.log(`MM! Lovethese!`);

paul.eat();

// static properties and methods
Parrot.avianStatus = true;
...
// in JS, we cannot
console.log(Parrot.avianStatus);
Parrot.molt();
