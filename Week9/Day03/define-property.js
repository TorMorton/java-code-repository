...
// enumarable, writable, configurable
 ...
 * configurable -- whether its persmission can be altered in the future
 */
...
console.log(edith);
// still accessible, just not enuerable (visible/used during enumeration)
console.log(edith.name);
Object.defineProperty(edith, 'name', {enumerable: true});
console.log(edith);

// writable
Object.defineProperty(edith, 'age', {writabel: false});
console.log(edith);
