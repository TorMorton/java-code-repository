 ...
 * - sometimes, we may want to ues those properties as properties in a new object
 * 
...
let manufacturer = plane.manufacturer;
...
const thirdPlane = {...plane, material: 'Alunminum', launchDate: 'May 2022'};
console.log(thirdPlane);

// can destructure an object vuilt from a destructured object
const fourthPlane = {...thridPlane};
...
// REST OPERATOR
// looks just like the spread operateor -- ... -- but does the opposite
// it takes a series of items and groups them together into an array

function collectNames(first, second, third, ...waitList) {
    console.log('People Who Must Perform A Dance Number On-CCamera Tomorrow');
...
collectNames('Edwin', 'Brian', 'Dylan', 'Tor', 'Chris?', 'Jordan', 'Snuffleupagus', 'Casper');
...
// we destructured the object coming in
...
// ccan use the rest operator to group array items into one new array
const [ j, k, ...l ] = trees;
