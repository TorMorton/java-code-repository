...
// functions that trigger from events can take the event itself in as a parameter ("e" here stands for event)
function handleSubmit(e) {
    // this prevents the default behavior of an event
    // in this case, a submit event would normally refresh the page
    e.preventDefault();
