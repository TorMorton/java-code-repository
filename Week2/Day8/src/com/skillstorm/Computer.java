...
//will be fully encapsulated class
public class Computer {
	
	//properties
	//all are gonna be private, only accessible from within the class
	...
	//this is a setter
	//happening on an object that's already been created
	//best practice for naming -- get plus Pascal Case variable name, so ramAmount setter is called setRamAmount
	...
	public String toString() {
		return "Computer [ramAmount=" + ramAmount + ", storageAmount=" + storageAmount + ", isLaptop=" + laptop
