...
public class StreamPractice {
	...
	/*
	 * What is a stream?
	 * DEFINITION: a sequence of elements that supports aggregate operations
	 ...
	 * 1. forEach - took each element, does soemthing with it, does not return anything
	 * 2. map - take each element, does something to it, returns the new element in a stream
	...
	public static void main(String[] args) {
		...
		// map
		Stream<String> foodStream2 = favoriteFoods.stream();
		Stream<String> newStream = foodStream2.map(f -> f.substring(2));
		System.out.println(newStream);
		//newStream.forEach(System.out::println); // (word) -> System.out.println(word)
		 
		// convert out stream back to a list
